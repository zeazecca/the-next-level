...
var IntAdapter = function(input) {
	this.input = input;
};
IntAdapter.__name__ = true;
IntAdapter.prototype = {
	get: function() {
		if(this.input.value.length == 0) {
			return null;
		}
		var value = Std.parseInt(this.input.value);
		if(value != null) {
			return value;
		}
		throw new js__$Boot_HaxeError("could not parse " + Std.string(this.input) + " as int");
	}
	,set: function(val) {
		this.input.placeholder = val == null ? "null" : "" + val;
	}
};
...
var RangeAdapter = function(input) {
	this.input = input;
};
RangeAdapter.__name__ = true;
RangeAdapter.prototype = {
	get: function() {
		if(this.input.value.length == 0) {
			return null;
		}
	...
	,set: function(val) {
		var tmp = "" + FloatExtensions.toString(val.min,1) + "—";
		var tmp1 = FloatExtensions.toString(val.max,1);
		this.input.placeholder = tmp + tmp1;
	}
};
...
FloatExtensions.toRange = function(val) {
...
Range.prototype = {
	...
	,div: function(quotient) {
		return new Range(this.min / quotient,this.max / quotient);
	}
};
var Std = function() { };
Std.__name__ = true;
...
Data.PLAYER_HITPROB = 0.6;
Data.CREATURE_HITPROB = 0.6;
Data.MIN_HIT = 0.05;
Data.MAX_HIT = 0.95;
Data.PROB_INCREMENTS = 0.05;
